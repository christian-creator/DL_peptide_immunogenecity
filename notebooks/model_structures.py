...
peptide_length_RNN = 10 #10 for pan specific model, 9 for allele specific 
...
class best_CNN(nn.Module):
    def __init__(self):
        ...
        # Denselayer
        in_dimensions_L_in = 18240 + 1938 # AAindex: 3840 + 408 # Combined: 17920 + 1904
...
if __name__ == "__main__":
    ...
    # sys.exit(1)
    print(net)
    peptide_random = np.random.normal(0,1, (10, 10, 57)).astype('float32')
    peptide_random = Variable(torch.from_numpy(peptide_random))
    HLA_random = np.random.normal(0,1, (10, 34, 57)).astype('float32')
